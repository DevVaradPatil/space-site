...
const Heroes = () => {
  const testimonials = [
    ...
    {
      quote:
        "We have to be ambitious and daring to reach new heights in science and space exploration.",
      name: "Satish Dhawan",
      designation:
        "Former Chairman of ISRO and Pioneer of Indian Space Research",
      src: "https://upload.wikimedia.org/wikipedia/en/3/3d/Satish_Dhawan.jpg",
    },
  ];
